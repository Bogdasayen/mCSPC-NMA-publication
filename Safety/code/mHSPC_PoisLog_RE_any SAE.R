...
cross_hr_re_any_SAE <- cross_effect(bugs_object = bugs_object_re, t_names = c("adt", "doce+adt", "enza+adt", "daro+doce+adt", "abi+adt", "apa+adt", "abi+doce+adt"), med = TRUE, exp = FALSE)
write.csv(x = cross_hr_re_any_SAE, file = "cross_hr_re_any_SAE.csv")
