...
cross_meandiff_fe_grade3 <- cross_effect(bugs_object = bugs_object_fe, t_names = c("adt", "doce+adt", "enza+adt", "daro+doce+adt", "abi+adt", "apa+adt", "abi+doce+adt"), med = TRUE, exp = TRUE)
