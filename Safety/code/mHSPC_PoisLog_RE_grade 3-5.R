...
ns <- nrow(grade_3_5_v2)
nt <- max(grade_3_5_v2$t1)
t  <- array(c(grade_3_5_v2$t1, grade_3_5_v2$t2), dim = c(ns, 2)) 
r  <- array(c(grade_3_5_v2$r1, grade_3_5_v2$r2), dim = c(ns, 2)) 
n  <- array(c(grade_3_5_v2$n1, grade_3_5_v2$n2), dim = c(ns, 2))
E <- array(c(grade_3_5_v2$E1, grade_3_5_v2$E2), dim = c(ns, 2))
...
cross_hr_re_grade_3_5 <- cross_effect(bugs_object = bugs_object_re, t_names = c("adt", "doce+adt", "enza+adt", "daro+doce+adt", "abi+adt", "apa+adt", "abi+doce+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_hr_re_grade_3_5, file = "cross_hr_re_grade_3_5.csv")
