...
cross_meandiff_re_nmr_pfs_denovo <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c(1:8), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_nmr_pfs_denovo, file = "cross_meandiff_re_nmr_pfs_denovo.csv")
