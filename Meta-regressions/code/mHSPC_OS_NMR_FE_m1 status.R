...
cross_meandiff_fe_OS_denovo <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c(1:8), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_OS_denovo, file = "cross_meandiff_fe_OS_denovo.csv")
