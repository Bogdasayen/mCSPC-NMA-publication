...
cross_meandiff_re_PFS_nonmeta <- cross_effect(bugs_object = bugs_object_re, t_names = c("daro+doce+adt", "doce+adt", "abi+adt", "adt", "apa+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_PFS_nonmeta, file = "cross_meandiff_re_PFS_nonmeta.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "abi+adt", "adt", "apa+adt"))
