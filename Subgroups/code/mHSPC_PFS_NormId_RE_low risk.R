...
cross_meandiff_re_pfs_lowrisk <- cross_effect(bugs_object = bugs_object_re, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_pfs_lowrisk, file = "cross_meandiff_re_pfs_lowrisk.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt"))
