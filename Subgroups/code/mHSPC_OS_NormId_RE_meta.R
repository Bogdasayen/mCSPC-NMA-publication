...
cross_meandiff_re_OS_meta <- cross_effect(bugs_object = bugs_object_re, t_names = c("daro+doce+adt", "doce+adt", "adt", "abi+adt", "apa+adt", "enza+adt", "abi+doce+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_OS_meta, file = "cross_meandiff_re_OS_meta.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "adt", "abi+adt", "apa+adt", "enza+adt", "abi+doce+adt"))
