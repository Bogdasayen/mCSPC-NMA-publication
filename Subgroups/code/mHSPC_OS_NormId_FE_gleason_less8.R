...
nt <- max(mHSPC_OS_data_gleason_less_than8$t1)
...
cross_meandiff_fe_gleasonless8 <- cross_effect(bugs_object = bugs_object_fe, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_gleasonless8, file = "cross_meandiff_fe_gleasonless8.csv")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt"))
