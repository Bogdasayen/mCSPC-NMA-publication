...
nt <- max(mHSPC_OS_data_gleason_greater8$t1)
...
cross_meandiff_fe_gleason8 <- cross_effect(bugs_object = bugs_object_fe, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_gleason8, file = "cross_meandiff_fe_gleason8.csv")
