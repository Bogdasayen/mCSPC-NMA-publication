...
cross_meandiff_re_pfs_highrisk <- cross_effect(bugs_object = bugs_object_re, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_pfs_highrisk, file = "cross_meandiff_re_pfs_highrisk.csv")
