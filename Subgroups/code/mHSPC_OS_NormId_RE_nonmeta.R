...
cross_meandiff_re_OS_nonmeta <- cross_effect(bugs_object = bugs_object_re, t_names = c("daro+doce+adt", "doce+adt", "adt", "abi+adt", "apa+adt", "enza+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_re_OS_nonmeta, file = "cross_meandiff_re_OS_nonmeta.csv")

calculate_sucra(bugs_object = bugs_object_re, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "adt", "abi+adt", "apa+adt", "enza+adt"))
