...
cross_meandiff_fe_OS_eligible <- cross_effect(bugs_object = bugs_object_fe, t_names = c("daro+doce+adt", "doce+adt", "enza+doce+adt", "abi+doce+adt", "adt", "apa+adt", "enza+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_OS_eligible, file = "cross_meandiff_fe_OS_eligible.csv")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "enza+doce+adt", "abi+doce+adt", "adt", "apa+adt", "enza+adt"))
