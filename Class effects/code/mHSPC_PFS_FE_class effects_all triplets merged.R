...
cross_meandiff_fe_pfs_base <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c("adt", "doc+adt", "dar+doc+adt", "enz+adt", "abi+adt", "apa+adt", "enz+doc+adt", "abi+doc+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_pfs_base, file = "cross_meandiff_fe_pfs_base.csv")
