...
cross_meandiff_fe_pfs_base <- cross_effect(bugs_object = bugs_object_fe_mams, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt", "enza+doce+adt", "abi+doce+adt"), med = TRUE, exp = TRUE)
write.csv(x = cross_meandiff_fe_pfs_base, file = "cross_meandiff_fe_pfs_base.csv")

calculate_sucra(bugs_object = bugs_object_fe, bugs_data = bugs_data, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt", "enza+doce+adt", "abi+doce+adt"))
calculate_sucra(bugs_object = bugs_object_fe_mams, bugs_data = bugs_data_mams, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt", "enza+doce+adt", "abi+doce+adt"))
