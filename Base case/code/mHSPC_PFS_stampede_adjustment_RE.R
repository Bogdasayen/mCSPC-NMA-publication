...
cross_meandiff_re_pfs_base <- cross_effect(bugs_object = bugs_object_re_mams, t_names = c("daro+doce+adt", "doce+adt", "enza+adt", "adt", "abi+adt", "apa+adt", "enza+doce+adt", "abi+doce+adt"), med = TRUE, exp = TRUE)
